...
ACTIVE_PRODUCTS = [
    ProductMetadata(stripe_id='prod_IyBrgm9STfw1kd', name='Demo Enterprise', features=['Demo Enterprise Feature 1', 'Demo Enterprise Feature 2', 'Demo Enterprise Feature 3'], description='The Demo Enterprise plan', is_default=False),
    ProductMetadata(stripe_id='prod_IyBrAe0EdFJj2u', name='Demo Premium', features=['Demo Premium Feature 1', 'Demo Premium Feature 2', 'Demo Premium Feature 3'], description='The Demo Premium plan', is_default=False),
    ProductMetadata(stripe_id='prod_IyBrUbyIjmfxnu', name='Demo Basic', features=['Demo Basic Feature 1', 'Demo Basic Feature 2', 'Demo Basic Feature 3'], description='The Demo Basic plan', is_default=False),
    ProductMetadata(stripe_id='prod_J8GJPnybxmdgqn', name='CE', features=['CE Feature 1', 'CE Feature 2', 'CE Feature 3'], description='The CE plan', is_default=False),
]
