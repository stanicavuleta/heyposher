...
urlpatterns = [
    ...
    path('', TemplateView.as_view(template_name="vue/index.html"), name="vue_app"),
    path(r'<path:path>', TemplateView.as_view(template_name="vue/index.html"), name="vue_app"),
